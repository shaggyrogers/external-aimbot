...
// Take a screenshot of the selected window, optionally in a specified region
// (if all of x, y, w, h are not -1)
// Returns a pointer to an array of size pixels (RGB) representing a width x
// height image
